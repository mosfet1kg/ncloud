module.exports = {
    getServerImageProductList: {
        ...
        param: [],required:[],
        request_alias: [], response_alias: [ { src: 'productCode', dst: 'vmImageTypeCode'}]
    },
    getServerProductList: {
        ...
        request_alias: [{src:'vmImageTypeCode', dst: 'serverImageProductCode'}], response_alias: [{ src:'productCode', dst: 'vmFlavorTypeCode' }]
    }
};